...
insert into article values (4, '내용입니다4','2020-08-05',true, 1)
insert into article values (5, '내용입니다5','2020-08-05',true, 1)
insert into article values (6, '내용입니다6','2020-08-06',true, 1)
insert into article values (7, '내용입니다7','2020-08-07',true, 1)
insert into article values (8, '내용입니다8','2020-08-07',true, 1)
insert into article values (9, '내용입니다9','2020-08-08',true, 1)
insert into article values (10, '내용입니다10','2020-08-09', true, 1)
insert into article values (11, '내용입니다11','2020-08-10', true, 1)
insert into article values (12, '내용입니다12','2020-08-10', true, 1)
insert into article values (13, '내용입니다13','2020-08-10', true, 1)
insert into article values (14, '내용입니다14','2020-08-10', true, 1)
insert into article values (15, '내용입니다15','2020-08-10', true, 1)
insert into article values (16, '내용입니다16','2020-08-11', true, 1)
insert into article values (17, '내용입니다17','2020-08-11', true, 1)
insert into article values (18, '내용입니다18','2020-08-11', true, 1)
insert into article values (19, '내용입니다19','2020-08-11', true, 1)
insert into article values (20, '내용입니다20','2020-08-11', true, 1)
...
insert into article_analysis_message values (1, '기쁜 일이 많았네요! 앞으로도 행복한 일이 가득하기를 바랄게요~', 1)
insert into article_analysis_message values (2, '슬픈 일이 많았네요.. 이제는 좋은 일만 찾아올 거에요.', 2)
insert into article_analysis_message values (3, '화나는 일이 많았네요~ 새벽에 훌훌 털어버렸기를!', 3)
insert into article_analysis_message values (4, '평온한 나날이었네요! 순탄한 삶도 좋죠~', 4)
insert into article_analysis_message values (5, '놀라운 일이 많았네요! 인생은 정말 예측하기 어려운 것 같아요~', 5)
insert into article_analysis_message values (6, '아팠던 일이 많았네요! 토닥토닥', 6)