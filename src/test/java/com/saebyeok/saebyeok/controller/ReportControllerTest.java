...
public class ReportControllerTest {
    ...
    public static final Long TEST_REPORTED_ID = 1L;
    ...
    private static final String TEST_TYPE = "ARTICLE";
    ...
    void createReportTest() throws Exception {
        ReportCreateRequest request = new ReportCreateRequest(TEST_REPORT_CONTENT, TEST_REPORTED_ID, TEST_CATEGORY_ID, TEST_TYPE);
    ...
    void noExistArticleIdTest() throws Exception {
        ...
        ReportCreateRequest request = new ReportCreateRequest(TEST_REPORT_CONTENT, null, TEST_CATEGORY_ID, TEST_TYPE);
        String requestAsString = OBJECT_MAPPER.writeValueAsString(request);
    ...
    void noExistCategoryIdTest() throws Exception {
        ...
        ReportCreateRequest request = new ReportCreateRequest(TEST_REPORT_CONTENT, TEST_REPORTED_ID, null, TEST_TYPE);
        String requestAsString = OBJECT_MAPPER.writeValueAsString(request);
    ...
    void noExistTypeStringTest() throws Exception {
        ...
        ReportCreateRequest request = new ReportCreateRequest(TEST_REPORT_CONTENT, TEST_REPORTED_ID, TEST_CATEGORY_ID, null);
        String requestAsString = OBJECT_MAPPER.writeValueAsString(request);
