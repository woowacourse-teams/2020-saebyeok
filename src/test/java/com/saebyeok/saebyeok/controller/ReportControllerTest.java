...
public class ReportControllerTest {
    ...
    void createReportTest() throws Exception {
        ReportCreateRequest request = new ReportCreateRequest(TEST_REPORT_CONTENT, TEST_REPORTED_ID, TEST_CATEGORY_ID, TEST_REPORT_TARGET);
    ...
    void noExistCategoryIdTest() throws Exception {
        ...
        ReportCreateRequest request = new ReportCreateRequest(TEST_REPORT_CONTENT, TEST_REPORTED_ID, null, TEST_REPORT_TARGET);
        String requestAsString = OBJECT_MAPPER.writeValueAsString(request);
