...
public class NicknameGeneratorTest {
    ...
    void setUp() {
        ...
        myArticle = new Article(1L, "내용", me, LocalDateTime.now(), true, new ArrayList<>());
        othersArticle = new Article(2L, "내용", other, LocalDateTime.now(), true, new ArrayList<>());
    }
    ...
    void severalCommentsByOneMemberTest() {
        ...
        String myNickname2 = nicknameGenerator.generate(
                me, new Article(2L, "게시물내용", other, LocalDateTime.now(), true, Arrays.asList(comment)));
