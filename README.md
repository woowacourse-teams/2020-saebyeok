...
또한 피드에서 필터를 사용해 보고 싶은 감정의 글만 볼 수도 있어요.<br/><br/>

<img src="./image/phone3.gif" width="30%" height="50%"/>
...
<img src="./image/phone5.gif" width="30%" height="30%">

### 공감과 댓글을 받을 수 있어요.

물론 줄 수도 있구요! 다른 사용자에게 공감과 댓글을 받을 수 있어요. 내가 받은 공감과 댓글의 개수도 확인할 수 있어요!

<img src="./image/phone6.png" width="30%" height="30%">
...
|                                                               그래                                                                |                                                                쪼밀리                                                                |                                                              카프카                                                              |                                                              쿨라임                                                              |                                                                 히로                                                                  |
| :-------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------: |
|                                                   ![그래](./image/member1.png)                                                    |                                                    ![쪼밀리](./image/member2.png)                                                    |                                                  ![카프카](./image/member3.png)                                                  |                                                  ![쿨라임](./image/member4.png)                                                  |                                                     ![히로](./image/member5.png)                                                      |
